...
#ifdef CD_MSF_FORMAT
#define CDPLAYER_MSF_FORMAT CD_MSF_FORMAT
#endif

#ifdef CD_LBA_FORMAT
#define CDPLAYER_LBA_FORMAT CD_LBA_FORMAT
#endif

#ifdef CDROM_MSF
#define CDPLAYER_MSF_FORMAT CDROM_MSF
#endif

#ifdef CDROM_MSF_FORMAT
#define CDPLAYER_MSF_FORMAT CDROM_MSF_FORMAT
#endif

#ifdef  CDIOREADTOCHEADER
#define CDPLAYER_READTOCHEADER CDIOREADTOCHEADER

#define CDPLAYER_TOCHEADER ioc_toc_header
...
#define CDPLAYER_READTOCHEADER CDROMREADTOCHDR

#define CDPLAYER_TOCHEADER cdrom_tochdr
#define CDPLAYER_READTOCHEADER CDROMREADTOCHDR
...
#define CDPLAYER_READTOCHEADER CDROM_TOC_HEADER

#define CDPLAYER_READTOCHEADER CDROM_TOC_HEADER
#define CDPLAYER_TOCHEADER cd_toc_header
...
#define CDPLAYER_READTOCENTRYS CDIOREADTOCENTRYS

#define CDPLAYER_TOCENTRY ioc_read_toc_entry
#define CDPLAYER_TOCENTRY_DATA cd_toc_entry 
...
#define CDPLAYER_READTOCENTRY CDROMREADTOCENTRY

#define CDPLAYER_TOCENTRY cdrom_tocentry
...
#define CDPLAYER_READTOCENTRYS CDROM_TOC_ENTRYS

#define CDPLAYER_TOCENTRY cd_toc
#define CDPLAYER_TOCENTRY_DATA cd_toc_entry
...
#define CDPLAYER_READSUBCHANNEL CDIOREADSUBCHANNEL

#define CDPLAYER_SUBCHANNEL ioc_read_subchannel
#define CDPLAYER_SUBCHANNEL_DATA cd_sub_channel_info
#define CDPLAYER_CDSC_DATA_FORMAT CD_CURRENT_POSITION
...
#define CDPLAYER_AS_PLAY_IN_PROGRESS CD_AS_PLAY_IN_PROGRESS
#define CDPLAYER_AS_PLAY_PAUSED CD_AS_PLAY_PAUSED
#define CDPLAYER_AS_PLAY_COMPLETED CD_AS_PLAY_COMPLETED
#endif /* CDIOREADSUBCHANNEL */

#ifdef CDROMSUBCHNL
#define CDPLAYER_READSUBCHANNEL CDROMSUBCHNL

#define CDPLAYER_SUBCHANNEL cdrom_subchnl
...
#define CDPLAYER_AS_PLAY_IN_PROGRESS CDROM_AUDIO_PLAY
#define CDPLAYER_AS_PLAY_PAUSED CDROM_AUDIO_PAUSED
#define CDPLAYER_AS_PLAY_COMPLETED CDROM_AUDIO_COMPLETED

#endif /* CDROMSUBCHNL */

#ifdef CDROM_READ_SUBCHANNEL
#define CDPLAYER_READSUBCHANNEL CDROM_READ_SUBCHANNEL

#define CDPLAYER_SUBCHANNEL cd_sub_channel
#define CDPLAYER_SUBCHANNEL_DATA cd_sub_channel_data
#define CDPLAYER_CDSC_DATA_FORMAT CDROM_SUBQ_DATA
...
#define CDPLAYER_AS_PLAY_IN_PROGRESS AS_PLAY_IN_PROGRESS
#define CDPLAYER_AS_PLAY_PAUSED AS_PLAY_PAUSED
#define CDPLAYER_AS_PLAY_COMPLETED AS_PLAY_COMPLETED

#endif /* CDROM_READ_SUBCHANNEL */

#ifdef  CDIOCPLAYMSF
#define CDPLAYER_PLAY_MSF CDIOCPLAYMSF

#define CDPLAYER_MSF	ioc_play_msf
...
#ifdef  CDROMPLAYMSF
#define CDPLAYER_PLAY_MSF CDROMPLAYMSF

#define CDPLAYER_MSF	cdrom_msf
...
#define CDPLAYER_PLAY_MSF CDROM_PLAY_AUDIO_MSF

#define CDPLAYER_MSF cd_play_audio_msf
...
#ifdef CDIOCSTART
#define CDPLAYER_START CDIOCSTART
#endif

#ifdef CDROMSTART
#define CDPLAYER_START CDROMSTART
#endif

#ifdef CDIOCSTOP
#define CDPLAYER_STOP CDIOCSTOP
#endif

#ifdef CDROMSTOP
#define CDPLAYER_STOP CDROMSTOP
#endif

#ifdef CDIOCPAUSE
#define CDPLAYER_PAUSE CDIOCPAUSE
#endif

#ifdef CDROMPAUSE
#define CDPLAYER_PAUSE CDROMPAUSE
#endif

#ifdef CDROM_PAUSE_PLAY
#define CDPLAYER_PAUSE CDROM_PAUSE_PLAY
#endif

#ifdef CDIOCRESUME
#define CDPLAYER_RESUME CDIOCRESUME
#endif

#ifdef CDROMRESUME
#define CDPLAYER_RESUME CDROMRESUME
#endif

#ifdef CDROM_RESUME_PLAY
#define CDPLAYER_RESUME CDROM_RESUME_PLAY
#endif

#ifdef CDIOCEJECT
#define CDPLAYER_EJECT CDIOCEJECT
#endif

#ifdef CDROMEJECT
#define CDPLAYER_EJECT CDROMEJECT
#endif

#ifdef CDIOCCLOSE
#define CDPLAYER_CLOSE CDIOCCLOSE
#endif

#ifdef CDROMCLOSETRAY
#define CDPLAYER_CLOSE CDROMCLOSETRAY
#endif

#ifdef CDIOCGETVOL
#define CDPLAYER_GET_VOLUME CDIOCGETVOL

#define CDPLAYER_VOLSTAT ioc_vol
...
#ifdef CDROMVOLREAD
#define CDPLAYER_GET_VOLUME CDROMVOLREAD

#define CDPLAYER_VOLSTAT cdrom_volctrl
...
#define CDPLAYER_GET_VOLUME CDROM_PLAYBACK_STATUS

#define CDPLAYER_VOLSTAT cd_playback
#define CDPLAYER_VOLSTAT_DATA cd_playback_status
...
#ifdef CDIOCSETVOL
#define CDPLAYER_SET_VOLUME CDIOCSETVOL

#define CDPLAYER_VOLCTRL ioc_vol
...
#ifdef CDROMVOLCTRL
#define CDPLAYER_SET_VOLUME CDROMVOLCTRL

#define CDPLAYER_VOLCTRL cdrom_volctrl
...
#define CDPLAYER_SET_VOLUME CDROM_PLAYBACK_CONTROL
#define CDPLAYER_MAX_VOLUME CDROM_MAX_VOLUME

#define CDPLAYER_VOLCTRL cd_playback_control
#define CDPLAYER_VOLCTRL_DATA cd_playback
#define CDPLAYER_VOLCTRL_SELECT 1
