...
#ifdef CD_MSF_FORMAT
#define CDLYTE_MSF_FORMAT CD_MSF_FORMAT
#endif

#ifdef CD_LBA_FORMAT
#define CDLYTE_LBA_FORMAT CD_LBA_FORMAT
#endif

#ifdef CDROM_MSF
#define CDLYTE_MSF_FORMAT CDROM_MSF
#endif

#ifdef CDROM_MSF_FORMAT
#define CDLYTE_MSF_FORMAT CDROM_MSF_FORMAT
#endif

#ifdef  CDIOREADTOCHEADER
#define CDLYTE_READTOCHEADER CDIOREADTOCHEADER

#define CDLYTE_TOCHEADER ioc_toc_header
...
#define CDLYTE_READTOCHEADER CDROMREADTOCHDR

#define CDLYTE_TOCHEADER cdrom_tochdr
#define CDLYTE_READTOCHEADER CDROMREADTOCHDR
...
#define CDLYTE_READTOCHEADER CDROM_TOC_HEADER

#define CDLYTE_READTOCHEADER CDROM_TOC_HEADER
#define CDLYTE_TOCHEADER cd_toc_header
...
#define CDLYTE_READTOCENTRYS CDIOREADTOCENTRYS

#define CDLYTE_TOCENTRY ioc_read_toc_entry
#define CDLYTE_TOCENTRY_DATA cd_toc_entry 
...
#define CDLYTE_READTOCENTRY CDROMREADTOCENTRY

#define CDLYTE_TOCENTRY cdrom_tocentry
...
#define CDLYTE_READTOCENTRYS CDROM_TOC_ENTRYS

#define CDLYTE_TOCENTRY cd_toc
#define CDLYTE_TOCENTRY_DATA cd_toc_entry
...
#define CDLYTE_READSUBCHANNEL CDIOREADSUBCHANNEL

#define CDLYTE_SUBCHANNEL ioc_read_subchannel
#define CDLYTE_SUBCHANNEL_DATA cd_sub_channel_info
#define CDLYTE_CDSC_DATA_FORMAT CD_CURRENT_POSITION
...
#define CDLYTE_AS_PLAY_IN_PROGRESS CD_AS_PLAY_IN_PROGRESS
#define CDLYTE_AS_PLAY_PAUSED CD_AS_PLAY_PAUSED
#define CDLYTE_AS_PLAY_COMPLETED CD_AS_PLAY_COMPLETED
#endif /* CDIOREADSUBCHANNEL */

#ifdef CDROMSUBCHNL
#define CDLYTE_READSUBCHANNEL CDROMSUBCHNL

#define CDLYTE_SUBCHANNEL cdrom_subchnl
...
#define CDLYTE_AS_PLAY_IN_PROGRESS CDROM_AUDIO_PLAY
#define CDLYTE_AS_PLAY_PAUSED CDROM_AUDIO_PAUSED
#define CDLYTE_AS_PLAY_COMPLETED CDROM_AUDIO_COMPLETED

#endif /* CDROMSUBCHNL */

#ifdef CDROM_READ_SUBCHANNEL
#define CDLYTE_READSUBCHANNEL CDROM_READ_SUBCHANNEL

#define CDLYTE_SUBCHANNEL cd_sub_channel
#define CDLYTE_SUBCHANNEL_DATA cd_sub_channel_data
#define CDLYTE_CDSC_DATA_FORMAT CDROM_SUBQ_DATA
...
#define CDLYTE_AS_PLAY_IN_PROGRESS AS_PLAY_IN_PROGRESS
#define CDLYTE_AS_PLAY_PAUSED AS_PLAY_PAUSED
#define CDLYTE_AS_PLAY_COMPLETED AS_PLAY_COMPLETED

#endif /* CDROM_READ_SUBCHANNEL */

#ifdef  CDIOCPLAYMSF
#define CDLYTE_PLAY_MSF CDIOCPLAYMSF

#define CDLYTE_MSF	ioc_play_msf
...
#ifdef  CDROMPLAYMSF
#define CDLYTE_PLAY_MSF CDROMPLAYMSF

#define CDLYTE_MSF	cdrom_msf
...
#define CDLYTE_PLAY_MSF CDROM_PLAY_AUDIO_MSF

#define CDLYTE_MSF cd_play_audio_msf
...
#ifdef CDIOCSTART
#define CDLYTE_START CDIOCSTART
#endif

#ifdef CDROMSTART
#define CDLYTE_START CDROMSTART
#endif

#ifdef CDIOCSTOP
#define CDLYTE_STOP CDIOCSTOP
#endif

#ifdef CDROMSTOP
#define CDLYTE_STOP CDROMSTOP
#endif

#ifdef CDIOCPAUSE
#define CDLYTE_PAUSE CDIOCPAUSE
#endif

#ifdef CDROMPAUSE
#define CDLYTE_PAUSE CDROMPAUSE
#endif

#ifdef CDROM_PAUSE_PLAY
#define CDLYTE_PAUSE CDROM_PAUSE_PLAY
#endif

#ifdef CDIOCRESUME
#define CDLYTE_RESUME CDIOCRESUME
#endif

#ifdef CDROMRESUME
#define CDLYTE_RESUME CDROMRESUME
#endif

#ifdef CDROM_RESUME_PLAY
#define CDLYTE_RESUME CDROM_RESUME_PLAY
#endif

#ifdef CDIOCEJECT
#define CDLYTE_EJECT CDIOCEJECT
#endif

#ifdef CDROMEJECT
#define CDLYTE_EJECT CDROMEJECT
#endif

#ifdef CDIOCCLOSE
#define CDLYTE_CLOSE CDIOCCLOSE
#endif

#ifdef CDROMCLOSETRAY
#define CDLYTE_CLOSE CDROMCLOSETRAY
#endif

#ifdef CDIOCGETVOL
#define CDLYTE_GET_VOLUME CDIOCGETVOL

#define CDLYTE_VOLSTAT ioc_vol
...
#ifdef CDROMVOLREAD
#define CDLYTE_GET_VOLUME CDROMVOLREAD

#define CDLYTE_VOLSTAT cdrom_volctrl
...
#define CDLYTE_GET_VOLUME CDROM_PLAYBACK_STATUS

#define CDLYTE_VOLSTAT cd_playback
#define CDLYTE_VOLSTAT_DATA cd_playback_status
...
#ifdef CDIOCSETVOL
#define CDLYTE_SET_VOLUME CDIOCSETVOL

#define CDLYTE_VOLCTRL ioc_vol
...
#ifdef CDROMVOLCTRL
#define CDLYTE_SET_VOLUME CDROMVOLCTRL

#define CDLYTE_VOLCTRL cdrom_volctrl
...
#define CDLYTE_SET_VOLUME CDROM_PLAYBACK_CONTROL
#define CDLYTE_MAX_VOLUME CDROM_MAX_VOLUME

#define CDLYTE_VOLCTRL cd_playback_control
#define CDLYTE_VOLCTRL_DATA cd_playback
#define CDLYTE_VOLCTRL_SELECT 1
